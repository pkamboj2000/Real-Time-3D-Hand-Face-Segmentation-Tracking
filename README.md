...
```bibtex
@misc{realtime_hand_face_tracking,
  title={Real-Time 3D Hand/Face Segmentation & Tracking},
  author={Your Name},
  year={2025},
  url={https://github.com/pkamboj2000/Real-Time-3D-Hand-Face-Segmentation-Tracking}
}
```
